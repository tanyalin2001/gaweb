...
//         </div>
//         <div className="flex-1">
//           <h3 className="text-xl font-semibold mt-4">行動牌（Action）：快速</h3>
//           <ul className="list-disc list-inside mt-2">
...
//         </div>
//         <div className="flex-1">
//           <h3 className="text-xl font-semibold mt-4">行動牌（Action）：慢速</h3>
//           <ul className="list-disc list-inside mt-2">
//             <li>單次使用的效果牌，用完即送入墓地</li>
...
export default function RulesPage() {
  return (
    <GuideLayout>
      ...
      {/* Section: 遊戲目標 */}
      <section className="bg-[#1a1a1a]/80 rounded-2xl p-6 md:p-10 shadow-lg border border-[#333]">
        <h2 className="text-3xl font-bold text-[#F28C7C] mb-4">遊戲目標</h2>
        <p>
          在 Grand Archive
          中，每位玩家操控一名「英雄」，目標是擊敗對手的英雄。當英雄受到的傷害累積達到其生命值時，就會死亡。誰先讓對方英雄死亡，就贏得比賽。

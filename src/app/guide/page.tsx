    ...
    <main className="relative min-h-screen text-white font-sans">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-8 pt-28 pb-20 space-y-10">
        ...
        <section>
          ...
          <p>
            在 Grand
            Archive中，每位玩家操控一名「英雄」，目標是擊敗對手的英雄。當英雄受到的傷害累積達到其生命值時，就會死亡。誰先讓對方英雄死亡，就贏得比賽。
          </p>
        </section>
        <section>
        ...
        <section>
          <h2 className="text-3xl font-bold text-[#F28C7C] mb-4">牌類型介紹</h2>
          ...
          <p className="list-disc list-inside mt-2">使用條件：</p>
        ...
        <section className="space-y-6 border-t border-[#F28C7C]/50 pt-10">
          ...
          <p className="text-gray-300">
            每位英雄都有職業屬性，例如：劍士（Blademaster）、魔導士（Magus）、守護者（Guardian）等，這些職業影響特定效果觸發與卡牌限制。
          </p>
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-200">
            <li className="bg-[#1f1f1f]/90 p-4 rounded-xl shadow-sm border border-[#F28C7C]/10">
              ⚔️ <strong>Blademaster</strong>：偏好使用武器，強調攻擊與裝備互動
            </li>
            <li className="bg-[#1f1f1f]/90 p-4 rounded-xl shadow-sm border border-[#F28C7C]/10">
              🪄 <strong>Magus</strong>：以行動牌與元素傷害為主，擅長控制與爆發
            </li>
            <li className="bg-[#1f1f1f]/90 p-4 rounded-xl shadow-sm border border-[#F28C7C]/10">
              🛡 <strong>Guardian</strong>：具備守護與減傷能力，專精防守
            </li>
            <li className="bg-[#1f1f1f]/90 p-4 rounded-xl shadow-sm border border-[#F28C7C]/10">
              🐾 <strong>Tamer</strong>：搭配野獸友軍，產生連動效果
            </li>
          </ul>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#1f1f1f]/90 p-6 rounded-xl shadow-md border border-[#F28C7C]/10">
              ...
              <p className="text-gray-300 text-sm">
                操作感強、能用武器疊攻，適合喜歡 tempo 操控與壓制力的玩家。
              </p>
            </div>
            <div className="bg-[#1f1f1f]/90 p-6 rounded-xl shadow-md border border-[#F28C7C]/10">
              <Image
              ...
              <p className="text-gray-300 text-sm">
                資源型控制型英雄，擅長用瞬間回應對手行動，能彈能解，變化靈活。
              </p>
            </div>
          </div>
        </section>
